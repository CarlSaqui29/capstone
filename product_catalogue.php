...
<BODY>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #222222 !important; color: #ffc107 !important;">
    <div class="container-fluid">
      ...
      <form class="d-flex">
        <a href="" class="btn btn-warning" style="transform: translateY(8px);">Logout <i class='bx bx-log-out'></i></a>
  ...
  <div id="shopping-cart">
    <div class="txt-heading">Shopping Cart<a id="btnEmpty" class="btn btn-danger mb-3" href="product_catalogue.php?action=empty">Empty Cart</a><a id="btnEmpty" class="btn btn-warning mb-3 mx-2" href="">Checkout</a></div>
    <?php
